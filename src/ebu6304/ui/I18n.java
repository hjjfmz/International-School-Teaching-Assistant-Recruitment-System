...
public final class I18n {
    ...
    static {
        ...
        zh.put("admin.ai.clear", "\u6E05\u7A7A");
        en.put("admin.ai.lookup", "\uD83D\uDD0D Lookup");
        zh.put("admin.ai.lookup", "\uD83D\uDD0D \u67E5\u7528\u6237");
        en.put("admin.ai.lookup.prompt", "Enter account or name:");
        zh.put("admin.ai.lookup.prompt", "\u8F93\u5165\u8D26\u53F7\u6216\u59D3\u540D\uFF1A");
        en.put("admin.ai.lookup.account", "Account record");
        zh.put("admin.ai.lookup.account", "\u8D26\u6237\u8BB0\u5F55");
        en.put("admin.ai.lookup.applicant", "Applicant profile");
        zh.put("admin.ai.lookup.applicant", "\u7533\u8BF7\u4EBA\u6863\u6848");
        en.put("admin.ai.lookup.notfound", "No match found");
        zh.put("admin.ai.lookup.notfound", "\u672A\u627E\u5230\u5339\u914D\u8BB0\u5F55");
        en.put("admin.ai.thinking", "AI is thinking...");
        zh.put("admin.ai.thinking", "AI \u601D\u8003\u4E2D\u2026");
        en.put("admin.ai.welcome", "Hello! I am your AI assistant. Ask me about users, jobs, applications, or workload.");
        zh.put("admin.ai.welcome", "\u4F60\u597D\uFF01\u6211\u662F TA \u62DB\u8058\u7CFB\u7EDF AI \u52A9\u624B\uFF0C\u53EF\u8BE2\u95EE\u7528\u6237\u3001\u804C\u4F4D\u3001\u7533\u8BF7\u6216\u5DE5\u4F5C\u91CF\u3002");
        en.put("admin.ai.error", "Error: {0}");
        zh.put("admin.ai.error", "\u9519\u8BEF\uFF1A{0}");
        en.put("admin.ai.endpoint", "Endpoint:");
        zh.put("admin.ai.endpoint", "\u63A5\u53E3\uFF1A");
        en.put("admin.ai.apikey", "API Key:");
        zh.put("admin.ai.apikey", "Key:");
        ...
        en.put("admin.workload.ai", "AI Workload Analysis");
        zh.put("admin.workload.ai", "AI \u5DE5\u4F5C\u91CF\u5206\u6790");
        en.put("admin.workload.ai.msg", "AI analysis result (read-only, no data is modified).");
        zh.put("admin.workload.ai.msg", "AI \u5206\u6790\u7ED3\u679C\uFF08\u4EC5\u4F9B\u53C2\u8003\uFF0C\u4E0D\u4FEE\u6539\u4EFB\u4F55\u6570\u636E\uFF09\u3002");
